const qnaList = [
  {
    ...
    a: [
      { answer: '\“00아~!\” 후배의 이름을 반갑게 부르며 뛰어간다.', type: [8, 9, 10, 11, 12, 13, 14, 15] },
      { answer: '후배에게 가까이 다가간 뒤 인사를 건넨다. \“00아 안녕?\"', type: [0, 1, 2, 3, 4, 5, 6, 7] },
    ]
  },
  {
    q: '\“선배! 우리 오늘 뭐 먹어요?\” 후배의 질문에 당신은…',
    a: [
      { answer: '내가 여기서 괜찮은 식당 3개 정도를 미리 찾아봤는데 골라볼래?', type: [0, 3, 2, 8] },
